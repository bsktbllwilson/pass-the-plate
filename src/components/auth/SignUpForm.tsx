...
export default function SignUpForm() {
  ...
  if (submitted) {
    return (
      <div className="font-body text-center">
        <h1 className="font-display font-medium tracking-[-0.01em] mb-3" style={{ fontSize: '2.5rem', lineHeight: '1.15' }}>Check your email</h1>
  ...
  return (
    <div className="font-body">
      <h1 className="font-display font-medium tracking-[-0.01em] mb-2 text-center" style={{ fontSize: '2.5rem', lineHeight: '1.1' }}>Get a seat at the table</h1>
