  ...
  return (
    <section className="px-4 py-20">
      <div className="mx-auto rounded-[35px] px-8 py-16 md:px-16 md:py-20 text-center" style={{ background: 'var(--color-brand)', maxWidth: '1540px' }}>
        <h2 className="font-display text-[var(--color-cream-soft)] font-medium tracking-[-0.01em] mb-6 mx-auto" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', lineHeight: '1.05', maxWidth: '900px' }}>
          Find Your Next Big <em style={{ fontStyle: 'italic' }}>Deal</em>
        </h2>
