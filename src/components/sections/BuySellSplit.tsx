    ...
    <section className="relative overflow-hidden" style={{ minHeight: 'clamp(400px, 55vw, 892px)' }}>
      ...
      <div className="relative z-10 h-full flex flex-col md:flex-row items-end px-4 pb-12 pt-40 gap-8" style={{ minHeight: 'inherit' }}>
        <div className="flex-1 md:pl-12">
          ...
          <a href="#" className="inline-flex items-center gap-3 px-8 py-5 rounded-3xl text-white font-medium text-xl" style={{ background: 'rgb(230,78,33)', fontFamily: 'var(--font-body)' }}>Buy A Business →</a>
        </div>
        <div className="flex-1 md:text-right md:pr-12">
          ...
          <a href="#" className="inline-flex items-center gap-3 px-8 py-5 rounded-3xl text-white font-medium text-xl" style={{ background: 'rgb(230,78,33)', fontFamily: 'var(--font-body)' }}>Sell A Business →</a>
        </div>
      </div>
    </section>
  )
