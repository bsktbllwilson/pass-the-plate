    ...
    <section className="relative overflow-hidden" style={{ minHeight: 'clamp(400px, 55vw, 892px)' }}>
      ...
      <div className="relative z-10 h-full flex flex-col md:flex-row items-end px-4 pb-12 pt-40 gap-8" style={{ minHeight: 'inherit' }}>
        <div className="flex-1 md:pl-12">
          <h2 className="font-display text-white font-medium tracking-[-0.01em] mb-6" style={{ fontSize: '2.1875rem', lineHeight: '1.1' }}>Find A Business<br />You&apos;re Hungry For</h2>
        ...
        <div className="flex-1 md:text-right md:pr-12">
          <h2 className="font-display text-white font-medium tracking-[-0.01em] mb-6" style={{ fontSize: '2.1875rem', lineHeight: '1.1' }}>Pass The Plate<br />To The Right Hands</h2>
