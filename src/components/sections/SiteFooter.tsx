...
export default function SiteFooter({ columns }: { columns: FooterColumn[] }) {
  return (
    <footer className="px-4 py-16" style={{ background: '#000', color: 'rgb(248,243,222)' }}>
      <div className="mx-auto" style={{ maxWidth: '1540px' }}>
        <div className="flex flex-col md:flex-row gap-12 md:gap-16">
          <div className="flex-shrink-0">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-medium" style={{ background: 'rgb(230,78,33)', borderColor: 'rgb(248,243,223)', color: '#fff', fontFamily: 'var(--font-body)' }}>
              English
