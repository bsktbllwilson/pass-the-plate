...
const INDUSTRY_LABEL: Record<Listing['industry'], string> = {
  restaurant: 'Restaurant', bakery: 'Bakery', grocery: 'Grocery',
  manufacturing: 'Manufacturing', catering: 'Catering',
}
            ...
            <section>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="rounded-2xl bg-white border border-black/10 p-5">
                  ...
                  <div className="font-medium" style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem' }}>{listing.square_footage.toLocaleString('en-US')}</div>
                </div>
              </div>
            </section>
          </div>
            ...
            <div className="lg:sticky lg:top-24 space-y-4">
              <div className="rounded-2xl bg-white border border-black/10 p-6">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <span className="px-3 py-1 rounded-full text-sm" style={{ background: 'rgb(255,239,124)', fontFamily: 'var(--font-body)' }}>{CUISINE_LABEL[listing.cuisine]}</span>
                  <span className="px-3 py-1 rounded-full text-sm border border-black/10" style={{ fontFamily: 'var(--font-body)' }}>{INDUSTRY_LABEL[listing.industry]}</span>
                </div>
              </div>
